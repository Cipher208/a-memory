...
from .base import _validate_layer, _check_rate_limit, _get_graph, _invalidate_cache
...
async def memory_graph_add(
    ...
    if hook_name:
        await tl._fire_hook(hook_name, layer, {"node_type": node_type, "content": content, "user_id": user_id})
...
async def memory_graph_query(
    ...
    await tl._fire_hook("retrieval_router", layer, {"query": tag or node_type, "user_id": user_id, "limit": limit})
