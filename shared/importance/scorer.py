...
class ImportanceScorer:
    ...
    def score(self, text: str, context: Optional[Dict[str, Any]] = None, **kwargs) -> ScorerResult:
        ...
        for signal in self._signals:
            ...
            if name == 'basetype': name = 'base'
            elif name == 'techkeyword': name = 'tech_keyword'
            elif name == 'retrieval': name = 'retrieval_signal'
            elif name == 'noise': name = 'noise_penalty'
            elif name == 'emotion': name = 'emotional'
        ...
        weights = config.weights or {
            'base': 1.0, 'length': 0.6, 'question': 0.5,
            'tech_keyword': 1.0, 'emotional': 0.8, 'novelty': 0.7,
            'retrieval_signal': 0.9, 'noise_penalty': 1.0
        }
        sum_pos = (
