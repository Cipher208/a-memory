"""
Circuit Breaker pattern for LLM/embedding calls (E2).
...
now WIRED: gates the embedding model path (shared/embeddings.py).
"""
...
class CircuitBreakerRegistry:
    ...
    def get(self, name: str, threshold: int = 3, recovery_timeout: float = 30.0, on_state_change: Callable[[str, CircuitState, CircuitState], None] | None = None) -> CircuitBreaker:
