...
# Moved verbatim to shared/tokens.py to break the hooks → base → context
# import cycle; underscore aliases keep every existing caller working.
from shared.tokens import estimate_tokens, truncate_to_budget
